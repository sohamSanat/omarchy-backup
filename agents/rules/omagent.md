...
- **UI/UX Agentic Architecture Specification**: Follow `/home/soham/.agents/rules/ui-ux-architecture.md` for the deterministic 3-turn interactive flow (Turn 1: UI Set Menu + Background Reference Deconstruction -> Turn 2: Cached Subagent 1 Ingestion + Harmonized Grill-Me -> Turn 3: Master Brief Synthesis + Git/Treehouse UI Workspace Provisioning), Herdr 2x2 multi-subagent swarm, on-demand Compound Engineering skills autonomy, dual-tier visual vs code reviewer protocol, and holistic remediation loop.
