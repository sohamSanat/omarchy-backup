(function () {
    ...
    class Connector {
        ...
        resetDevFixes(type) {
            chrome.runtime.sendMessage({
                type: MessageTypeUItoBG.RESET_DEV_FIXES,
                data: {type}
            });
        }
    ...
    function PerSiteConfigEditor(props) {
        const context = getComponentContext();
        const store = context.getStore({
            errorText: "",
            fixes: [],
        ...
        return m$1(
            "div",
            {class: "config-editor-per-site"},
            m$1(
                "div",
                {class: "config-editor-per-site__search-wrapper"},
                m$1(TextBox, {
                    class: "config-editor-per-site__search-input js-search",
                    type: "text",
            ...
            m$1(
                "list",
                {class: "config-editor-per-site__urls"},
                        ...
                        m$1(
                            Button,
                            {
                                class: {
                                    ...
                                    "config-editor-per-site__url--active":
            ...
            store.currentFix
                ...
                : m$1(
                      "div",
                      {class: "config-editor-per-site__add-fix"},
                      m$1(
                          Button,
                          {
                              onclick: addNewFix,
                              class: "config-editor-per-site__add-fix__button"
                          },
                          "Create new fix"
                      ),
                      m$1(
                          "p",
                          {
                              class: "config-editor-per-site__add-fix__description"
                          },
                          "Search for an ",
    ...
    function ConfigEditorTabs(props) {
        const context = getComponentContext();
            ...
            m$1(
                ...
                m$1(
                    ...
                    m$1(ConfigEditor, {
                        ...
                        apply: (text) =>
                            props.actions.applyDevFixes(props.type, text),
    ...
    function Body(props) {
        ...
        return m$1(
            ...
            m$1(
                    ...
                    m$1(ConfigEditorTabs, {
                        ...
                        create: (url) => {
                            return {
                                ...
                                noinvert: [".example_icon-to-not-invert"],
                                removebg: [".example_remove-background"],
                                css: [
                ...
                m$1(
                    TabPanel$1.Tab,
                    {id: "detector-editor", label: "Detector Hints Editor"},
                    m$1(ConfigEditorTabs, {
                        ...props,
                        type: "detector",
                        ...
                        create: (url) => {
                            return {
                                url: [url],
                                target: "html",
                                match: [".example-dark-theme-selector"],
                                noDarkTheme: false,
                                systemTheme: false,
                                iframe: false
                            };
