(function () {
    ...
    class Connector {
        ...
        toggleOmarchyTheme(active) {
            chrome.runtime.sendMessage({
                type: MessageTypeUItoBG.TOGGLE_OMARCHY_THEME,
                data: active
            });
        }
        markNewsAsRead(ids) {
    ...
    function SiteToggleGroup(props) {
        ...
        } else if (props.data.settings.omarchyThemeActive && isPageEnabled) {
            descriptionText = "Omarchy System Theme Active";
        ...
        return m$1(
            ...
            m$1(
                ...
                m$1(
                    ...
                    m$1(
                        "strong",
                        {class: "m-donate-button__darkreader"},
                        "Dark Reader"
                    )
                )
            ),
    ...
    function OmarchyToggle({data, actions}) {
        const isActive = Boolean(
            data &&
            data.settings &&
            data.settings.omarchyThemeActive
        );
        ...
        return m$1(
            ...
            {
                class: {
                    "omarchy-toggle-btn": true,
                    "omarchy-toggle-btn--active": isActive
                },
                onclick: () => {
                    if (actions && typeof actions.toggleOmarchyTheme === "function") {
                        actions.toggleOmarchyTheme(!isActive);
                    }
                }
            },
            m$1("span", {class: "omarchy-toggle-btn__indicator"}),
            m$1("span", {class: "omarchy-toggle-btn__text"}, isActive ? "omarchy (active)" : "omarchy")
        );
    }
    ...
    function FilterSettings({data, actions}, ...children) {
        ...
        return m$1(
            ...
            m$1(OmarchyToggle, {data: data, actions: actions}),
