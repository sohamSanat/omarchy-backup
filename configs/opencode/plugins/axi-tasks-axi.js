// axi-sdk-js managed opencode plugin: tasks-axi
// This file is generated by axi-sdk-js. It is safe to edit only if you remove the managed marker above.
import { spawn } from "node:child_process";

const command = "tasks-axi";
const marker = "tasks-axi";
const ambientHeader = "## AXI ambient context: tasks-axi";
...
export const AxiTasksAxiAmbientContextPlugin = async ({ directory }) => {
