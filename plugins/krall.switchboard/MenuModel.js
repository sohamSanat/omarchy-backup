// Copied verbatim from Omarchy's first-party menu plugin
// ($OMARCHY_PATH/shell/plugins/menu/MenuModel.js) so Switchboard parses the
// same omarchy-menu.jsonc files, guards, providers, and search scoring as
// the built-in menu. Keep in sync when Omarchy changes the menu format.
